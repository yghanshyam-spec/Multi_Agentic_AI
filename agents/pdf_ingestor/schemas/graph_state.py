"""
agents/pdf_ingestor/schemas/graph_state.py
======================================
Graph state definition for the PDFIngestor agent.
...
class PDFIngestorGraphState(BaseAgentState):
    """
    Extended state for PDFIngestor.
