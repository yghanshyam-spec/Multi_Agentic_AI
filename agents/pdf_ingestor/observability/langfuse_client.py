"""
agents/pdf_ingestor/observability/langfuse_client.py
================================================
Observability wrapper for the PDFIngestor agent.
...
Usage
-----
    from agents.pdf_ingestor.observability.langfuse_client import get_agent_tracer
...
def get_agent_tracer() -> AgentTracer:
    """Return an AgentTracer scoped to the PDFIngestor agent."""
    return get_tracer("pdf_ingestor_agent")
