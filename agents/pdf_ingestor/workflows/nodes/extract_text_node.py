"""
agents/pdf_ingestor/workflows/nodes/extract_text_node.py
==========================================================
Node function: ``extract_text_node``
...
def extract_text_node(state):
    ...
    result=extractor.extract(state.get("pdf_path","document.pdf"))
    return {"extracted_pages":result["pages"],"page_count":result["page_count"],"is_scanned":result["is_scanned"],
            "current_node":"extract_text_node",
            "execution_trace":[build_trace_entry("extract_text_node",int((time.monotonic()-t0)*1000))]}
