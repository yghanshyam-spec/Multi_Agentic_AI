"""
agents/pdf_ingestor/workflows/create_graph.py
=========================================
LangGraph graph assembly for the PDFIngestor agent.
...
Usage
-----
    from agents.pdf_ingestor.workflows.create_graph import build_pdf_ingestor_graph
    graph = build_pdf_ingestor_graph()
...
def build_pdf_ingestor_graph():
    """
    Assemble and compile the PDFIngestor LangGraph workflow.
    ...
    # from agents.pdf_ingestor.workflows.nodes.my_node import my_node_fn
