"""
agents/pdf_ingestor/agents/base_agent.py
...
class BasePdfIngestorAgent(BaseAgent):
    """Base for all pdf_ingestor specialist implementations."""
    AGENT_NAME = "pdf_ingestor_agent"
