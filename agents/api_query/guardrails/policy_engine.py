"""
agents/api_query/guardrails/policy_engine.py
==========================================
Policy engine for the APIQuery agent.
...
class APIQueryPolicyGuardrail(BaseGuardrail):
    """Content safety and policy checker for APIQuery."""

    name = "api_query_policy"
