"""
agents/api_query/observability/langfuse_client.py
================================================
Observability wrapper for the APIQuery agent.
...
Usage
-----
    from agents.api_query.observability.langfuse_client import get_agent_tracer
...
def get_agent_tracer() -> AgentTracer:
    """Return an AgentTracer scoped to the APIQuery agent."""
    return get_tracer("api_query_agent")
