"""
agents/router/guardrails/policy_engine.py
==========================================
Policy engine for the Router agent.
...
class RouterPolicyGuardrail(BaseGuardrail):
    """Content safety and policy checker for Router."""
