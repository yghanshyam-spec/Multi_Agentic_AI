"""
agents/audit/observability/langfuse_client.py
================================================
Observability wrapper for the Audit agent.
...
Usage
-----
    from agents.audit.observability.langfuse_client import get_agent_tracer
...
def get_agent_tracer() -> AgentTracer:
    """Return an AgentTracer scoped to the Audit agent."""
    return get_tracer("audit_agent")
