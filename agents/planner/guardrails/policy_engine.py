"""
agents/planner/guardrails/policy_engine.py
==========================================
Policy engine for the Planner agent.
...
class PlannerPolicyGuardrail(BaseGuardrail):
    """Content safety and policy checker for Planner."""
