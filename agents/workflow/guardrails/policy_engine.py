"""
agents/workflow/guardrails/policy_engine.py
==========================================
Policy engine for the Workflow agent.
...
class WorkflowPolicyGuardrail(BaseGuardrail):
    """Content safety and policy checker for Workflow."""
