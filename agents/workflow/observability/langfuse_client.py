"""
agents/workflow/observability/langfuse_client.py
================================================
Observability wrapper for the Workflow agent.
...
Usage
-----
    from agents.workflow.observability.langfuse_client import get_agent_tracer
...
def get_agent_tracer() -> AgentTracer:
    """Return an AgentTracer scoped to the Workflow agent."""
    return get_tracer("workflow_agent")
