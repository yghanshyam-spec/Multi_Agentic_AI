"""
agents/execution/schemas/graph_state.py
======================================
Graph state definition for the Execution agent.
...
class ExecutionGraphState(BaseAgentState):
    """
    Extended state for Execution.
