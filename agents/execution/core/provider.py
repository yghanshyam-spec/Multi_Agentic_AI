"""
agents/execution/core/provider.py
================================
LLM provider wrapper for the Execution agent.
...
LLM configuration overrides (e.g. lower temperature for deterministic outputs).
    ...
    from agents.execution.core.provider import get_agent_llm
    llm = get_agent_llm()
"""
...
def get_agent_llm(**overrides):
    """
    Return an LLM configured for the Execution agent.
