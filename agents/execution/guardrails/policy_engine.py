"""
agents/execution/guardrails/policy_engine.py
==========================================
Policy engine for the Execution agent.
...
class ExecutionPolicyGuardrail(BaseGuardrail):
    """Content safety and policy checker for Execution."""
