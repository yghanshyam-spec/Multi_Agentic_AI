"""
agents/execution/workflows/nodes/manage_sandbox_node.py
=========================================================
Node function: ``manage_sandbox_node``
...
def manage_sandbox_node(state):
    t0 = time.monotonic()
    return {"sandbox_id": provision_sandbox(), "current_node": "manage_sandbox_node",
            "execution_trace": [build_trace_entry("manage_sandbox_node", int((time.monotonic()-t0)*1000))]}
