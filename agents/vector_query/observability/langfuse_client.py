"""
agents/vector_query/observability/langfuse_client.py
================================================
Observability wrapper for the VectorQuery agent.
...
Usage
-----
    from agents.vector_query.observability.langfuse_client import get_agent_tracer
...
def get_agent_tracer() -> AgentTracer:
    """Return an AgentTracer scoped to the VectorQuery agent."""
    return get_tracer("vector_query_agent")
