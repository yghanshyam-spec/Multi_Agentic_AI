"""
agents/vector_query/workflows/nodes/embed_query_node.py
=========================================================
Node function: ``embed_query_node``
...
def embed_query_node(state):
    ...
    embedding=vs.embed_query(state.get("original_query",""),model=model)
    return {"query_embedding":embedding,"embedding_model":model,"current_node":"embed_query_node",
            "execution_trace":[build_trace_entry("embed_query_node",int((time.monotonic()-t0)*1000))]}
