"""
agents/vector_query/workflows/create_graph.py
=========================================
LangGraph graph assembly for the VectorQuery agent.
...
Usage
-----
    from agents.vector_query.workflows.create_graph import build_vector_query_graph
    graph = build_vector_query_graph()
...
def build_vector_query_graph():
    """
    Assemble and compile the VectorQuery LangGraph workflow.
    ...
    # from agents.vector_query.workflows.nodes.my_node import my_node_fn
