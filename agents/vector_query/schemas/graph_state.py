"""
agents/vector_query/schemas/graph_state.py
======================================
Graph state definition for the VectorQuery agent.
...
class VectorQueryGraphState(BaseAgentState):
    """
    Extended state for VectorQuery.
