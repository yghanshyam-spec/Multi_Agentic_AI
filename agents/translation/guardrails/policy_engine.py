"""
agents/translation/guardrails/policy_engine.py
==========================================
Policy engine for the Translation agent.
...
class TranslationPolicyGuardrail(BaseGuardrail):
    """Content safety and policy checker for Translation."""
