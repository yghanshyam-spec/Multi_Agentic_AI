"""
agents/translation/observability/langfuse_client.py
================================================
Observability wrapper for the Translation agent.
...
Usage
-----
    from agents.translation.observability.langfuse_client import get_agent_tracer
...
def get_agent_tracer() -> AgentTracer:
    """Return an AgentTracer scoped to the Translation agent."""
    return get_tracer("translation_agent")
