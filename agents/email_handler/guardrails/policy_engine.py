"""
agents/email_handler/guardrails/policy_engine.py
==========================================
Policy engine for the EmailHandler agent.
...
class EmailHandlerPolicyGuardrail(BaseGuardrail):
    """Content safety and policy checker for EmailHandler."""

    name = "email_handler_policy"
