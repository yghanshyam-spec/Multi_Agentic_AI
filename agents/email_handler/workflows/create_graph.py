"""
agents/email_handler/workflows/create_graph.py
=========================================
LangGraph graph assembly for the EmailHandler agent.
...
Usage
-----
    from agents.email_handler.workflows.create_graph import build_email_handler_graph
    graph = build_email_handler_graph()
...
def build_email_handler_graph():
    """
    Assemble and compile the EmailHandler LangGraph workflow.
    ...
    # from agents.email_handler.workflows.nodes.my_node import my_node_fn
