"""
agents/email_handler/observability/langfuse_client.py
================================================
Observability wrapper for the EmailHandler agent.
...
Usage
-----
    from agents.email_handler.observability.langfuse_client import get_agent_tracer
...
def get_agent_tracer() -> AgentTracer:
    """Return an AgentTracer scoped to the EmailHandler agent."""
    return get_tracer("email_handler_agent")
