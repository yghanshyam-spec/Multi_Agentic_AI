"""
agents/mcp_invoker/workflows/create_graph.py
=========================================
LangGraph graph assembly for the MCPInvoker agent.
...
Usage
-----
    from agents.mcp_invoker.workflows.create_graph import build_mcp_invoker_graph
    graph = build_mcp_invoker_graph()
...
def build_mcp_invoker_graph():
    """
    Assemble and compile the MCPInvoker LangGraph workflow.
    ...
    # from agents.mcp_invoker.workflows.nodes.my_node import my_node_fn
