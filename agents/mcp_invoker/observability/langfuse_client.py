"""
agents/mcp_invoker/observability/langfuse_client.py
================================================
Observability wrapper for the MCPInvoker agent.
...
Usage
-----
    from agents.mcp_invoker.observability.langfuse_client import get_agent_tracer
...
def get_agent_tracer() -> AgentTracer:
    """Return an AgentTracer scoped to the MCPInvoker agent."""
    return get_tracer("mcp_invoker_agent")
