"""
agents/notification/workflows/create_graph.py
=========================================
LangGraph graph assembly for the NotificationAgent agent.
...
Usage
-----
    from agents.notification.workflows.create_graph import build_notification_agent_graph
...
def build_notification_agent_graph():
    """
    Assemble and compile the NotificationAgent LangGraph workflow.
    ...
    # from agents.notification.workflows.nodes.my_node import my_node_fn
