"""
agents/notification/guardrails/policy_engine.py
==========================================
Policy engine for the NotificationAgent agent.
...
class NotificationAgentPolicyGuardrail(BaseGuardrail):
    """Content safety and policy checker for NotificationAgent."""

    name = "notification_agent_policy"
