"""
agents/scheduling/workflows/create_graph.py
=========================================
LangGraph graph assembly for the SchedulingAgent agent.
...
Usage
-----
    from agents.scheduling.workflows.create_graph import build_scheduling_agent_graph
    graph = build_scheduling_agent_graph()
...
def build_scheduling_agent_graph():
    """
    Assemble and compile the SchedulingAgent LangGraph workflow.
    ...
    # from agents.scheduling.workflows.nodes.my_node import my_node_fn
