"""
agents/scheduling/guardrails/policy_engine.py
==========================================
Policy engine for the SchedulingAgent agent.
...
class SchedulingAgentPolicyGuardrail(BaseGuardrail):
    """Content safety and policy checker for SchedulingAgent."""

    name = "scheduling_agent_policy"
