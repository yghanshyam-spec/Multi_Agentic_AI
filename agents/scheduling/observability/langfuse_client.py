"""
agents/scheduling/observability/langfuse_client.py
================================================
Observability wrapper for the SchedulingAgent agent.
...
Usage
-----
    from agents.scheduling.observability.langfuse_client import get_agent_tracer
...
def get_agent_tracer() -> AgentTracer:
    """Return an AgentTracer scoped to the SchedulingAgent agent."""
    return get_tracer("scheduling")
