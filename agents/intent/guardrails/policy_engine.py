"""
agents/intent/guardrails/policy_engine.py
==========================================
Policy engine for the Intent agent.
...
class IntentPolicyGuardrail(BaseGuardrail):
    """Content safety and policy checker for Intent."""
