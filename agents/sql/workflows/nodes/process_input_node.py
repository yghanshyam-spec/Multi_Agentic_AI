"""
agents/sql/workflows/nodes/process_input_node.py
========================================================
Node function: ``process_input_node``
...
def process_input_node(state):
    t0=time.monotonic()
    return {"cleaned_request": state.get("raw_input","").strip(), "status": ExecutionStatus.RUNNING,
            "current_node":"process_input_node",
            "execution_trace":[build_trace_entry("process_input_node",int((time.monotonic()-t0)*1000))]}
