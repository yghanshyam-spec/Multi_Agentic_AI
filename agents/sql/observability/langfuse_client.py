"""
agents/sql/observability/langfuse_client.py
================================================
Observability wrapper for the SQLAgent agent.
...
Usage
-----
    from agents.sql.observability.langfuse_client import get_agent_tracer
...
def get_agent_tracer() -> AgentTracer:
    """Return an AgentTracer scoped to the SQLAgent agent."""
    return get_tracer("sql")
