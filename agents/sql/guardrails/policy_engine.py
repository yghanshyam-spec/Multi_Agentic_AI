"""
agents/sql/guardrails/policy_engine.py
==========================================
Policy engine for the SQLAgent agent.
...
class SQLAgentPolicyGuardrail(BaseGuardrail):
    """Content safety and policy checker for SQLAgent."""

    name = "sql_agent_policy"
