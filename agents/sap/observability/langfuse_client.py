"""
agents/sap/observability/langfuse_client.py
================================================
Observability wrapper for the SAPAgent agent.
...
Usage
-----
    from agents.sap.observability.langfuse_client import get_agent_tracer
...
def get_agent_tracer() -> AgentTracer:
    """Return an AgentTracer scoped to the SAPAgent agent."""
    return get_tracer("sap")
