"""
agents/sap/guardrails/policy_engine.py
==========================================
Policy engine for the SAPAgent agent.
...
class SAPAgentPolicyGuardrail(BaseGuardrail):
    """Content safety and policy checker for SAPAgent."""

    name = "sap_agent_policy"
