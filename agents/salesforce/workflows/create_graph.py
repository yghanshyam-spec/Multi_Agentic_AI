"""
agents/salesforce/workflows/create_graph.py
=========================================
LangGraph graph assembly for the Salesforce agent.
...
Usage
-----
    from agents.salesforce.workflows.create_graph import build_salesforce_graph
...
def build_salesforce_graph():
    """
    Assemble and compile the Salesforce LangGraph workflow.
    ...
    # from agents.salesforce.workflows.nodes.my_node import my_node_fn
