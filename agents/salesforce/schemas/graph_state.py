"""
agents/salesforce/schemas/graph_state.py
======================================
Graph state definition for the Salesforce agent.
...
class SalesforceGraphState(BaseAgentState):
    """
    Extended state for Salesforce.
