"""
agents/salesforce/guardrails/policy_engine.py
==========================================
Policy engine for the Salesforce agent.
...
class SalesforcePolicyGuardrail(BaseGuardrail):
    """Content safety and policy checker for Salesforce."""

    name = "salesforce_policy"
