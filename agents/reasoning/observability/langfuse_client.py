"""
agents/reasoning/observability/langfuse_client.py
================================================
Observability wrapper for the Reasoning agent.
...
Usage
-----
    from agents.reasoning.observability.langfuse_client import get_agent_tracer
...
def get_agent_tracer() -> AgentTracer:
    """Return an AgentTracer scoped to the Reasoning agent."""
    return get_tracer("reasoning_agent")
